    ...
    Protected Sub cpluubl_Callback(source As Object, e As CallbackEventArgs)
        Try
            ...
            For i = 0 To clsbangluong.Count - 1
                ...
                vitriluu = item.duongdanfile.Replace("http://27.71.231.212:8001", "D:\EDOC_TEST\WEBEDOC\Edoc0103")
                ...
                If Session("Login") = "dochuc@cavn.vn" Then
                    ...
                    Call serv.Thietlaptaikhoanky(idfile, "dangvucuong@gmail.com", 2, 1, Session("Login"))
                    Call serv.Thietlaptaikhoanky(idfile, "hangdtt@cavn.vn", 3, 1, Session("Login"))
                    'Call serv.Thietlaptaikhoanky(idfile, "phamduongcntt60@gmail.com", 3, 1, Session("Login"))

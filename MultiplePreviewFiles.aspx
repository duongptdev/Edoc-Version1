<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MultiplePreviewFiles.aspx.vb" Inherits="MultiplePreviewFiles" %>

<!DOCTYPE html><!--  This site was created in Webflow. http://www.webflow.com  -->
<!--  Last Published: Tue Mar 02 2021 02:22:13 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="603ca7c8dce047b9bd3e04e5" data-wf-site="5fc9e8d6d24a3a09aec5cdc3">

<head>
    <meta charset="utf-8">
    <title>Preview File</title>
    <meta content="Preview File" property="og:title">
    <meta content="Preview File" property="twitter:title">
...
<body>
    <div class="background-modal align-top">
    ...
    <header id="nav" class="sticky-nav">
        <div class="close">
            <a href="../index.html" class="back-to-home w-inline-block"><img src="Content/images/Icons-Close-16px.svg" /></a>
        </div>
        <div class="step-tab">
            <div class="done---step">
            ...
            <div class="spacing---step"><img src="Content/images/Group-14878.svg" loading="lazy" alt=""></div>
            <div class="non-step">
                <div class="dot-step"><img src="Content/images/Group-14877.svg" loading="lazy" alt=""></div>
    ...
    <div class="add-receiver-body">
        <div class="preview-file-body">
            <div class="heading-receiver">
                <div class="heading-step">Kiểm tra dữ liệu</div>
            </div>
            <div class="file-check-info">
                ...
                <a href="#" class="sign-map w-inline-block">
                    <div class="map-text">Xem sơ đồ lệnh ký</div><img src="Content/images/Sign-Map.png" loading="lazy"
                        alt="">
                </a>
            </div>
            <div class="file-info-table">
                ...
                <div class="add-receiver-button remove-margin">
                    <a href="../upload-file.html" class="back-button w-button">Quay lại</a>
                    <a href="MultipleReviewAndSend.aspx" class="next-button w-button">Tiếp tục (78/90)</a>
                </div>
            </div>
        </div>
        <div class="footer">
        ...
        <script>
            ...
            (function showAllModal() {
                ...
                var allButton = document.querySelector(".view-all-file.w-inline-block");
                var allModal = document.querySelector(".background-modal.align-top");
                var closeButton = document.querySelector(".close-button.add-margin");

                allButton.addEventListener("click", function () {

                    if (allModal.style.display === 'none') {
                ...
                closeButton.addEventListener("click", function () {
                    ...
                    if (allModal.style.display === 'block') {
                        allModal.style.display = 'none';
                    } else {
                        allModal.style.display = 'block';
                    }

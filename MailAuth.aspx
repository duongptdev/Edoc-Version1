            ...
            <div class="card-content">
                <div class="content-container top-password">
                    ...
                    <div class="email-form w-form">
                            ...
                            <label for="Password" class="form-label">Mã xác
                                minh</label><input type="number" class="form-field w-input" autofocus="true"
                                name="OTP-password" placeholder="Nhập mã xác minh"

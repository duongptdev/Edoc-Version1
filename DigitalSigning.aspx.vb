...
Partial Class DigitalSigning
    ...
    Protected Sub cpsign_Callback(source As Object, e As DevExpress.Web.CallbackEventArgs)
        ...
        End Try
    End Sub
    Protected Sub cpendsign_Callback(source As Object, e As DevExpress.Web.CallbackEventArgs)
        Dim arr As String() = e.Parameter.Split("|")
        ...
        e.Result = res
    End Sub
    Protected Sub cpupdate_Callback(source As Object, e As DevExpress.Web.CallbackEventArgs)

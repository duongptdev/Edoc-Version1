...
Partial Class Register
    ...
    Private Sub Register_Load(ByVal Sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Protected Sub btnDangKy_Click(sender As Object, e As EventArgs)
        ...
        If txtHoTen.Text = String.Empty Then
            lblname.Text = "* Trường bắt buộc phải nhập"
        ElseIf txtSDT.Text = String.Empty Then
            lblsdt.Text = "* Trường bắt buộc phải nhập"
        Else

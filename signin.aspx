    ...
    <form id="form1" runat="server">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="content-container">
                        <div class="heading-card">Đăng nhập</div>
                        <div class="subtitle-card">
                            Đăng nhập bằng thông tin bạn đã nhập khi<br>
                        ...
                        <div class="email-form w-form">
                            <div id="email-form" name="email-form" data-name="Email Form" method="post" class="form">
                               ...
                               <%--  <input type="button" onclick="Checkaccount()" value="Đăng nhập" class="form-button button-color w-button text-center" style="color:white" />--%>
                                <asp:Button ID="btnDangNhap" runat="server" Text="Đăng nhập" CssClass="form-button button-color w-button text-center" OnClick="btnDangNhap_Click" />
                            </div>
                        ...
                        <div class="text-link-wrapper">
                            ...
                            <a href="#" class="link-container w-inline-block">
                                <div class="link">Quên mật khẩu</div>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-image">
                    <img src="Content/images/Group-14555.png" loading="lazy" alt="" class="image">
                </div>
            </div>
            <div class="copyright">
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#txtPass").attr("placeholder", "Mật khẩu");
